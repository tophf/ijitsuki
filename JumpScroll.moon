...
hStatusbar = ffi.C.FindWindowExA hApp, 0, ffi.cast('uintptr_t','msctls_statusbar32'), 0
hContainer = ffi.C.FindWindowExA hApp, 0, ffi.cast('uintptr_t','wxWindowNR'), 0
hSubsGrid = ffi.C.FindWindowExA hContainer, 0, 0, 0
hScrollbar = ffi.C.FindWindowExA hSubsGrid, 0, 0, 0
