...
aegisub.register_macro script_name, script_description, (subs, sel) ->
    dlg = {
        ...
        {'floatedit', 1,0,1,1, name:'pos_x', hint:'Shift x coordinate of \\pos'}
        {'floatedit', 2,0,1,1, name:'pos_y', hint:'Shift y coordinate of \\pos'}

        {'label',     0,1,1,1, label:'\\move'}
        {'floatedit', 1,1,1,1, name:'move_x1', hint:'Shift first x coordinate of \\move'}
        {'floatedit', 2,1,1,1, name:'move_y1', hint:'Shift first y coordinate of \\move'}
        {'floatedit', 3,1,1,1, name:'move_x2', hint:'Shift second x coordinate of \\move'}
        {'floatedit', 4,1,1,1, name:'move_y2', hint:'Shift second y coordinate of \\move'}

        {'label',     0,2,1,1, label:'\\org'}
        {'floatedit', 1,2,1,1, name:'org_x', hint:'Shift x coordinate of \\org'}
        {'floatedit', 2,2,1,1, name:'org_y', hint:'Shift y coordinate of \\org'}

        {'label',     0,3,1,1, label:'\\clip'}
        {'floatedit', 1,3,1,1, name:'clip_x', hint:'Shift x coordinate of \\clip'}
        {'floatedit', 2,3,1,1, name:'clip_y', hint:'Shift y coordinate of \\clip'}

        {'label',     0,4,1,1, label:'\\p'}
        {'floatedit', 1,4,1,1, name:'p_x', hint:'Shift x coordinate of \\p drawing'}
        {'floatedit', 2,4,1,1, name:'p_y', hint:'Shift y coordinate of \\p drawing'}
    }
    for c in *dlg
